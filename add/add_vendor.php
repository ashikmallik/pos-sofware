...
//===================Add Function===================
   ...
   if(isset ($_POST['submit'])){
       ...
       $service_add=$obj->insert_by_condition("tbl_vendor", $form_data, " ");
                ...
                <div class="row" style="padding:10px; font-size: 12px;">
                    ...
                    <div class="col-md-6">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" name="Contact" class="form-control" id="ResponsiveTitle"  >
                       </div>
                       <div class="form-group">
                            <label>Vendor Email</label>
                            <input type="text" name="Email" class="form-control" id="ResponsiveTitle"  >
                       </div>                                                                                                           
                        <div class="form-group">                                                         
                            <label>Status</label>
