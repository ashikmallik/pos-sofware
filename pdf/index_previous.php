...
<div width="27%" height="40px" style="text-align:center;color:#FFF;background-color:#575757;display:inline-block;padding:25px;float:left;border-right:3px solid white;" >
'.$cu_type.'<br>'.$detailsid['cus_id'].'
</div>
<div width="60%" height="42px" style="background-color:#575757; color:#FFF;display:inline-block;padding:25px;float:left;text-align:center;" >
<div width="33.33%" height="42px" style="background-color:#575757;display:inline-block;color:#FFF;float:left;" >
...
<div width="33.33%" height="42px" style="background-color:#575757;color:#FFF;display:inline-block;float:left;" >
Date:<br>
'.$date.'
</div>
</div>
...
In word:<br> '.$formater -> convert_number_to_words( $bill->get_customer_dues($detailsid['ag_id'])).'
</div>
