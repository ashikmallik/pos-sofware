...
if(!empty($personId)){
    ...
    $allPersonLoanData = $obj->view_all_by_cond("tbl_company_lend", "person_id = $personId AND created_at BETWEEN '$startDate' and '$endDate'");
}
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <input type="hidden" value="view_single_company_loan" name="q">
                ...
                foreach ($allPersonLoanData as $loan) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" onclick="return confirm('Are you sure you want to delete this Loan Record?');" href="?q=view_single_company_loan&personid=<?php echo $personId;?>&deleteloanId=<?php echo $loan['id']; ?>" class="btn btn-danger btn-xs">
            ...
            buttons: [
                {
                    ...
                    footer: true,
                    title: function () {
                        return "Loan Giver <?php echo $personData['person_name'];?>"
                    },
                    exportOptions: {
                        columns: [0,1,2,3,4]
                    },
