...
//$allPersonLoan = $obj->view_selected_field_by_cond_left_join("tbl_person_loan", 'tbl_person', 'person_id', 'id', 'SUM(tbl_person_loan.loan_recieve) as total_loan_recieve, SUM(tbl_person_loan.loan_repayment) as total_loan_repayment', '*', "tbl_person_loan.id != 0 AND tbl_person_loan.created_at BETWEEN '$startDate' and '$endDate' GROUP BY tbl_person_loan.`person_id`");
...
if (isset($_POST['submit_loan_payment'])) {
    ...
    if ($total_loan_check < 0){
        ...
        $form_data_for_bank = array(
            ...
            'description' => 'Provide Loan re payment to Person(From Loan Borrower list).',
            'credit' => 0,
            'debit' =>  $_POST['loan_re_payment'],
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <input type="hidden" value="all_person_loan" name="q">
                </div>
            </div>
        </div>
        <div class="col-md-2">
        ...
        <table class="table table-responsive table-bordered table-hover " id="datatable-btn">
            ...
            foreach ($allPersonLoan as $personLoan) {
                ...
                <tr>
                    ...
                    <td class=""><a href="?q=view_single_person_loan&personid=<?php echo $personLoan['id'] ?><?php if (isset($_GET['startDate'])){ echo '&startDate='.$_GET['startDate'].'&endDate='.$_GET['endDate'].'&search=';}?>"><?php echo $personLoan['person_name'] ?></a>
                    </td>
                    ...
                    <td class="text-right"> <?php echo ($totalLoan < 0) ? '(Advance) ' : ''; echo number_format(abs($totalLoan)) ?> </td>

                    <td class="text-center action-btn">
                        <button class="edit btn btn-success btn-sm" id="payment_button" data-toggle="modal" data-target="#editloan" data-id="<?php echo $personLoan['id'] ?>" data-loan="<?php echo $totalLoan ?>" data-person="<?php echo $personLoan['person_name'] ?>">Payment
                        </button>
                    </td>
                </tr>
            <?php } ?>
        ...
        <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn">
                                ...
                                <input onkeypress="return numbersOnly(event)" require type="number" name="loan_re_payment" id="loan_re_payment" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="hidden" id="input_person_id" name="person_id" value="">
            ...
            buttons: [
                {
                    ...
                    footer:true,
                    title: function () {
                        return "Print Loan Borrowers List"
                    },
