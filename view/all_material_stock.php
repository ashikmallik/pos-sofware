...
$allPurchaseData  = $obj->view_all_ordered_by("vw_purchase_material_stock", "`vw_purchase_material_stock`.`total_purchase_qty` DESC");
?>
...
<div class="col-md-12 bg-primary" style="margin-top:20px; margin-bottom: 15px;">
    <div class="col-md-8">
        <h4><strong>All Material Stock Item</strong></h4>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped" id="datatable-btn">
                ...
                <tr>
                    ...
                    <th class="text-center col-md-1">Total Used</th>
                ...
                foreach ($allPurchaseData as $stock) {
                    $i++;
                    ...
                    $allUsedData  = $obj->details_by_cond("vw_used_material", " product_id=".$stock['product_id']);
                    ?>
                    <tr>
                        ...
                        <td class="text-right"><?php isset($allUsedData['qty']) ? $used_qty = $allUsedData['qty'] : $used_qty = 0;
                            echo number_format($used_qty) ;
                            $total_used += $used_qty;
                            ?>
                        </td>

                        <?php
                        $stockQty = $purchase_qty - $used_qty ;
                ...
                <tr>
                    ...
                    <th class="text-right "><?php echo number_format($total_used);  ?></th>
                    <th class="text-right "><?php echo number_format($total_stock);  ?></th>
                </tr>
            </table>
        </div>
    </div>
            ...
            buttons: [
                {
                    ...
                    footer: true,
                    title: function () {
                        return "All Material Stock Item <?php echo date('d, M Y')?>"
                    },
                    exportOptions: {
                        columns: [0,1,2,3,4,5]
                    },
