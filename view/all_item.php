        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tbody>
                    ...
                    $sellItemData = $obj->view_all("tbl_item_with_price");

                    foreach ($sellItemData as $item) {
                        $category = $obj->details_by_cond("tbl_category", "cat_id=".$item['category']);
                        $i++;
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="?q=view_product_ledger&product=<?php echo @$item['item_id'] ?>" ><?php echo isset($item['item_name']) ? $item['item_name'] : NULL; ?></a>
                            </td>

                            <td class="text-center"><?php echo isset($item['item_price']) ? number_format($item['item_price'], 1) . ' TK.' : NULL;   echo isset($item['unit']) && !empty($item['unit']) ? ' / '.$item['unit'] :NULL?></td>
                        ...
                        <div class="form-group" style="margin-bottom:20px;">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" required="required" name="unit">
                                    <option></option>
                                    <?php
                                    foreach ($obj->view_all("tbl_unit") as $unit) {
                                        ?>
                                        <option value="<?php echo isset($unit['name']) ? $unit['name'] : NULL; ?>"><?php echo isset($unit['name']) ? $unit['name'] : NULL; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
