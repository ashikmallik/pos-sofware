            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($allSellData as $sell) {
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php $sumOfTotalPrice += $sell['total_price']; echo isset($sell['total_price']) ? number_format($sell['total_price']) . ' TK.' : NULL; ?></td>
                        <td class="text-right"><?php $sumOfPayment += $sell['payment_recieved']; echo isset($sell['payment_recieved']) ? number_format($sell['payment_recieved']) . ' TK.' : NULL; ?></td>
