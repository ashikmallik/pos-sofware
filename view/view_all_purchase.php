...
$allPurchaseData = $obj->view_all_by_cond("vw_purchase", "`vw_purchase`.`material`=0 ORDER BY `vw_purchase`.`bill_id` DESC");
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($allPurchaseData as $purchase) {
                    ...
                    $unit = isset($purchaseItemData[0]['unit'])? $purchaseItemData[0]['unit']: NULL;

                    $i++;
                    $purchase_id = $purchase['bill_id'];
                    $iframButton = '<button href="view/view_purchase_item.php?billId=' . $purchase_id . '" class="btn btn-info bg-slate-700 btn-xs open-popup-link" data-effect="mfp-zoom-in">' . number_format($purchase['total_qty'])." ".$unit.' </a></button>'; ?>
                    <tr>
            ...
            <!-- New Table: Purchase Item Details -->
