...
if (!empty($_SESSION['UserId'])) {
    ...
    $purchaseItemData = $obj->view_all_by_cond('vw_purchase_item', "supplier='".$_GET['supid']."' AND MONTH(entry_date)=".$dateMonth." AND YEAR(entry_date)=".$dateYear." ");
    $supplierData = $obj->details_by_cond('tbl_supplier', "supplier_id = '" . $_GET['supid'] . "'");
    ?>
    <!DOCTYPE html>
    <html>
    <head>
