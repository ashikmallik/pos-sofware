        ...
        <div class="col-md-12" id="month_print">
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" id="datatable-btn">
                    ...
                    $balance = 0;
                    foreach ($obj->view_all_by_cond("bank_account", $where . " ORDER BY account_id") as $value) {
                        ...
                        if ($val <= 0) {
                            ...
                            echo isset($value['diposited_by']) ? $value['diposited_by'] : NULL;
                                ...
                                <td class="text-right"><?php echo isset($balance) ? $balance : NULL; ?></td>
                            </tr>
                        <?php
                        $bank_total_withdraw += isset($value['credit']) ? $value['credit'] : NULL;
                        $bank_total_diposit += isset($value['debit']) ? $value['debit'] : NULL;
                    } ?>
                    </tbody>	
                    <tfoot>
                        <tr style="font-size:18px;font-weight:900;">
                            <td colspan="7" style="text-align:right;"><b>Grand Total</b></td>
                            <td class="text-right"><b><?php echo $bank_total_diposit; ?></b></td>
                            <td class="text-right"><b><?php echo $bank_total_withdraw; ?></b></td>
                            <td class="text-right"><b><?php echo $bank_total_diposit - $bank_total_withdraw; ?></b></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
