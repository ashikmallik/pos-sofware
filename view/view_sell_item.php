...
if (!empty($_SESSION['UserId'])) {
    ...
    $saleItemData = $obj->view_all_by_cond('vw_sell_item', "sell_id = '$invoiceId'");
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-bordered">
                                ...
                                $total_qty = 0;
                                $total_price = 0;
                                foreach($saleItemData as $saleItem){
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $saleItem['price'];?> taka </td>
                                        <td><?php echo $saleItem['qty'].' '.$unit;?></td>
                                        <td><?php echo number_format($saleItem['commission_per_unit']);?> taka </td>
