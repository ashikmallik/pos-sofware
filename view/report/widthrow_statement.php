...
$accountDetailsBank = $sell_details = $obj->view_all_by_cond("bank_account", "entry_date BETWEEN '$startDate' and '$endDate' and withdrow_or_deposit=2 ORDER BY `bank_account`.`entry_date` ASC");
    ...
    <div class="col-md-12" style="font-size:12px;">
        <table class="table table-responsive table-bordered table-hover table-striped" id="datatable-btn">
            ...
            <tr class="bg-slate-800">
                ...
                <th class="col-md-2 text-center">Account Type</th>

                <th class="col-md-5 text-center">Description</th>
                <th class="col-md-1 text-center">Entry By</th>
                <th class="col-md-1 text-center">Withdrow Blance</th>
           ...
           // $balance = 0;
            $total_credit = 0;
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php echo isset($account['mobile_banking_name']) ? ($account['mobile_banking_name']) : null; ?>
                    </td>
                    <td class="">
