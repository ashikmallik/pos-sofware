...
$accountDetailsBank = $sell_details = $obj->view_all_by_cond("bank_account", "entry_date BETWEEN '$startDate' AND '$endDate' AND `type` IN (3, 4, 5) ORDER BY `bank_account`.`entry_date` ASC");
