...
$whereCondition = "(acc_type ='$expenseCat')";
            ...
            <table class="table table-bordered table-hover table-striped" id="example">
                ...
                foreach ($expenseData as $value) {
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo isset($value['acc_amount']) ? number_format($value['acc_amount']) . ' tk' : NULL;
                            ?></td>
                ...
                <tr>
                    ...
                    <th colspan="1" class="text-right"><?php echo number_format($totalExpense);?> Tk</th>
                    <th></th>
                </tr>
                </tfoot>
            </table>
            ...
            buttons: [
                {
                    ...
                    text: 'Print Expense',
                    title: function () {
                        return "Expense Report <?php echo $time; ?>"
                    },
