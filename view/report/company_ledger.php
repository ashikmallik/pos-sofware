...
<div class="col-md-12 bg-teal-800" style="margin-bottom: 20px;padding:5px 0px">
    <form action="" method="POST">
        ...
        <div class="col-md-2 col-md-offset-3">
            <button type="submit" name="search" class="btn btn-success"><span class="glyphicon  glyphicon-search"></span>&nbsp;&nbsp;Search
            </button>
        </div>
    </form>
</div>
...
<div class="row" id="year_table">
    <h4 class="text-center">Company Ledger, <?php if (isset($_POST['dateYear'])){echo $_POST['dateYear'];}else{echo date('Y');} ?> </h4>
    <div class="col-md-12">
        <table class="table table-responsive table-bordered table-hover table-striped">
            ...
            foreach ($obj->view_all('acc_type_list') as $accType) {
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo number_format($january) ?> </td>
                    <td class="text-right"><?php echo number_format($february) ?> </td>
                    <td class="text-right"><?php echo number_format($march) ?> </td>
                    <td class="text-right"><?php echo number_format($april) ?> </td>
                    <td class="text-right"><?php echo number_format($may) ?> </td>
                    <td class="text-right"><?php echo number_format($june) ?> </td>
                    <td class="text-right"><?php echo number_format($july) ?> </td>
                    <td class="text-right"><?php echo number_format($august) ?> </td>
                    <td class="text-right"><?php echo number_format($september) ?> </td>
                    <td class="text-right"><?php echo number_format($october) ?> </td>
                    <td class="text-right"><?php echo number_format($november) ?> </td>
                    <td class="text-right"><?php echo number_format($december) ?> </td>
                </tr>
                <?php
            } // foreach
            ?>
            ...
            <tr class="bg-grey-800">
                ...
                <td class="text-right"><?php echo number_format($totalJanuary) ?> </td>
                <td class="text-right"><?php echo number_format($totalFeb) ?> </td>
                <td class="text-right"><?php echo number_format($totalMarch) ?> </td>
                <td class="text-right"><?php echo number_format($totalApril) ?> </td>
                <td class="text-right"><?php echo number_format($totalMay) ?> </td>
                <td class="text-right"><?php echo number_format($totalJune) ?> </td>
                <td class="text-right"><?php echo number_format($totalJuly) ?> </td>
                <td class="text-right"><?php echo number_format($totalAugust) ?> </td>
                <td class="text-right"><?php echo number_format($totalSeptember) ?> </td>
                <td class="text-right"><?php echo number_format($totalOctober) ?> </td>
                <td class="text-right"><?php echo number_format($totalNovember) ?> </td>
                <td class="text-right"><?php echo number_format($totalDecember) ?> </td>
            </tr>
            </tfoot>
        </table>
    </div>
