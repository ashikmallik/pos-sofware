            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($todaySell as $sell) {
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo isset($sell['payment_recieved']) ? number_format($sell['payment_recieved']) . ' TK.' : NULL; ?></td>
                        <td class="text-right"><?php echo isset($sell['due_to_company']) ? number_format($sell['due_to_company']) . ' TK.' : NULL; ?></td>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td class="text-center"><?php echo number_format($total_qty) ?> TK.</td>
                    <td class="text-right"><?php echo number_format($total_price) ?> TK.</td>
                    <td class="text-right"><?php echo number_format($total_payment) ?> TK.</td>
                    <td class="text-right"><?php echo number_format($total_dues) ?> TK.</td>
                    <td></td>
                    <td></td>
                </tr>
                </tfoot>
