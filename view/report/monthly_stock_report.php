            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($monthlyStock as $stockItem) {
                    ...
                    <tr>
                        ...
                        <td class=""><?php echo $stockItem['product_name']; ?></td>
                        <?php if ($stockItem['purchase_sell_flag'] == '1') {
                            ...
                            <td class="text-right"><?php echo $stockItem['qty']; ?></td>
                            <td class="text-right"><?php echo $stockItem['price']; ?></td>
                            <td class="text-right"><?php echo $stockItem['total_amount']; ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        <?php } else {
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-right"><?php echo $stockItem['qty']; ?><br></td>
                            <td class="text-right"><?php echo $delivery;?><br></td>
                            <td class="text-right"><?php echo $stockItem['price']; ?></td>
                            <td class="text-right"><?php echo $stockItem['total_amount']; ?></td>
                        <?php } ?>
                        ...
                        <td class="text-center">
                            <?php if ($stockItem['purchase_sell_flag'] == '1') { ?>
                                <a class="btn btn-sm btn-default" target="_blank" href="pdf/bill.php?billId=<?php echo $bill_sell_array[1]; ?>">
                                    <span class="glyphicon glyphicon-print"></span> Print
                                </a>
                            <?php } else { ?>
                                <a class="btn btn-sm btn-default" target="_blank" href="pdf/invoice.php?invoiceId=<?php echo $bill_sell_array[1]; ?>">
                                    <span class="glyphicon glyphicon-print"></span> Print
                                </a>
                            <?php } ?>
                        </td>
                ...
                <tr>
                    ...
                    <th class="text-right "><?php echo number_format($total_purchase_unit); ?></th>
                    <th class="text-right "><?php echo number_format($total_purchase_price);  ?></th>
                    <th class="text-right "><?php echo number_format($total_amount_price);  ?></th>
                    <th class="text-right "><?php echo number_format($total_sell_unit);  ?></th>
                    <th class="text-right "><?php  ?></th>
                    <th class="text-right "><?php echo number_format($total_sell_price);  ?></th>
                    <th colspan="1" class="text-right"><?php echo number_format($total_sell);  ?></th>
