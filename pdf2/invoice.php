...
if($current < 0){
        ...
        $ttext =  '<tr>
        <th colspan="5" style="font-size:14px; padding:5px; text-align:right">Total Advance</th>
        ...
        $ttext =  '<tr>
        <th colspan="5" style="font-size:14px; padding:5px; text-align:right">Total Due</th>
        <th style="font-size:14px; text-align:right;padding:5px;">' . number_format(abs($current),2) . '</th>
        </tr>';
...
if($previous < 0){
        $preAdv=abs($previous);
        $ptext =  '<tr>
        <th colspan="5" style="font-size:14px; padding:5px; text-align:right">Previous Advance</th>
        ...
        $preDue=abs($previous);
        $ptext =  '<tr>
        <th colspan="5" style="font-size:14px; padding:5px; text-align:right">Previous Due</th>
        <th style="font-size:14px; text-align:right;padding:5px;">(+)' . number_format(abs($previous),2) . '</th>
        </tr>';
...
foreach ($sellItemData as $sellItem) {
    ...
    if ($less_amount != '0') {
        $lessAmountRow = '<tr>
                    <th colspan="5" style="font-size:14px;text-align: right;font-weight: bold;">Less Amount &nbsp;</th>
    ...
    $mainbody .= '              
                <div width="100%">
                    <div class="heading text-center">
                        <img class="header" style="height:500px; width:auto;" src="./img/header.jpg" />
                    </div>
                    ...
                    <table width="100%" class="table-bordered items table" style="margin-top:10px;">
                        ...
                        <tbody id="invoice">
                            ' . $invoiceRow . '
                            <tr>
                                <th colspan="5" style="font-size:14px; padding:5px; text-align:right"> Total</th>
                                <th style="font-size:14px; text-align:right;padding:5px;">' . number_format($total_taka,2) . '</th>
                            </tr>
                            '.$lessAmountRow.'
                             '.$tClCtext.'
                             '.$ptext.'
                             <tr> <th colspan="6" ><hr style="padding:0;margin:0;"></th> </tr>
                            <tr>
                                <th colspan="2" style="font-size:14px; padding:5px;"> Labour Name: '.$labour_name.'</th>
                            ...
                            <tr>
                                <th colspan="5" style="font-size:14px; padding:5px; text-align:right"> Payment</th>
                            ...
                            <tr>
                                <td colspan="2" style="font-size:14px;padding-left: 5px;">Total Amount in word</td>
