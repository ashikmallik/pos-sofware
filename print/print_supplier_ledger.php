                    ...
                    foreach ($supplierPaymentData as $supPay) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                else if ($supPay['acc_type'] == 9) {echo 'Supplier Opening Advance';}
                                else if ($supPay['acc_type'] == 10) {echo 'Supplier Opening Due';}
                                else {echo 'N/A';}
                                ?>
...
<script>
    ...
    printDiv('print_supplier_ledger');
</script>
