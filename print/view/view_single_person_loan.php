...
if (!empty($personId)) {
    ...
    $allPersonLoanData = $obj->view_all_by_cond("tbl_person_loan", "person_id = $personId");
}
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button"
                               ...
                               href="?q=view_single_person_loan&personid=<?php echo $personId; ?>&deleteloanId=<?php echo $loan['id']; ?>"
