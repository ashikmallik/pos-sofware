            ...
            foreach ($allSupplierSecurityMoneyReceive as $supplierSecMoney) { ?>
                <tr>
                    ...
                    <td class="text-center"><a
                            href="?q=view_single_supplier_security_money&supplierid=<?php echo $supplierSecMoney['id'] ?>"><?php echo $supplierSecMoney['supplier_name'] ?></a>
                    </td>
                    <td class="text-center"> <?php echo $supplierSecMoney['supplier_mobile_no'] ?> </td>
                    <td class="text-center"> <?php echo $supplierSecMoney['supplier_address'] ?> </td>
                    <td class="text-center"> <?php echo number_format($supplierSecMoney['total_receive']) ?> </td>
                    ...
                    <td class="text-center"> <?php echo ($totalSupplierSecurityMoney < 0) ? '(Advance) ' : '';
                    ...
                    <td class="text-center action-btn">
                        <button class="edit btn btn-success btn-sm" data-toggle="modal" data-target="#backToCompany"
                                data-id="<?php echo $supplierSecMoney['id'] ?>"
                                data-supplier="<?php echo $supplierSecMoney['supplier_name'] ?>">Money Back
                        </button>
                    </td>
                </tr>
            <?php } ?>
