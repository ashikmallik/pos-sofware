            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($todayPurchase as $purchase) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo isset($purchase['payment_recieved']) ? number_format($purchase['payment_recieved']) . ' TK.' : NULL; ?></td>
                        <td class="text-center"><?php echo isset($purchase['due_to_company']) ? number_format($purchase['due_to_company']) . ' TK.' : NULL; ?></td>
                ...
                <tr>
                    ...
                    <th class="text-center "><?php echo number_format($total_payment);  ?></th>
                    <th class="text-center "><?php echo number_format($total_due);  ?></th>
