...
<div class="col-md-12 bg-grey-800" style="margin-top:20px; margin-bottom: 15px;">
    <div class="col-md-6">
        <h4><strong>Accounts Statement
                Between <?php echo date("d-M-Y", strtotime($startDate)) . " to " . date("d-M-Y", strtotime($endDate)); ?></strong>
        </h4>
    </div>

    <div class="col-md-6" style="padding-top:5px;">
        <button type="submit" class="btn btn-primary btn-sm pull-right" onclick="printDiv('acc_statment_print')">Print
            Statement
        </button>
    </div>
</div>
