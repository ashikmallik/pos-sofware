...
$allPurchaseData = $obj->view_all_ordered_by("vw_purchase", "`vw_purchase`.`bill_id` DESC");
...
<div class="col-md-12 bg-slate-600" style="margin-top:20px; margin-bottom: 15px;">
    <div class="col-md-6">
        <h4><strong>View All Purchase List</strong></h4>
    </div>
            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                foreach ($allPurchaseData as $purchase) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo isset($purchase['total_qty']) ? $iframButton : NULL; ?></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group" style="margin-top:5px">
                                <a type="button"
                                   data-name = "<?php echo isset ($purchase['supplier_name']) ? $purchase['supplier_name'] : null; ?>"
                                ...
                                <a type="button"
                                   onclick="return confirm('Are you sure you want to delete this Purchase item?');"
                                   href="?q=view_all_purchase&deletePurchaseId=<?php echo $purchase['bill_id']; ?>"
                                   class="btn btn-danger btn-xs">
                                    <span class="glyphicon glyphicon-trash"></span> Delete
                                </a>
                                <a type="button" target="_blank" href="pdf/bill.php?billId=<?php echo $purchase_id ?>"
