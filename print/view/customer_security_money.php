            ...
            foreach ($allCustomerSecurityMoneyGiven as $customerSecMoney) { ?>
                <tr>
                    ...
                    <td class="text-center"><a
                                href="?q=view_single_customer_security_money&customerid=<?php echo $customerSecMoney['id'] ?>"><?php echo $customerSecMoney['cus_name'] ?></a>
                    </td>
                    <td class="text-center"> <?php echo $customerSecMoney['cus_mobile_no'] ?> </td>
                    <td class="text-center"> <?php echo $customerSecMoney['cus_address'] ?> </td>
                    <td class="text-center"> <?php echo number_format($customerSecMoney['total_given']) ?> </td>
                    ...
                    <td class="text-center action-btn">
                        <button class="edit btn btn-success btn-sm" data-toggle="modal" data-target="#backToCompany"
                                ...
                                data-customer="<?php echo $customerSecMoney['cus_name'] ?>">Back To Company
                        </button>
                    </td>
                </tr>
            <?php } ?>
